...
It maybe required for you to use a SD Card to initially flash your board. If this is required then be sure to use a good quality SD card that is no more than 32GB in size. Additionally it should be formated with either FAT16 (sometimes just called FAT), or FAT32 with a clustersize of 8kb or 4kb.
:::
